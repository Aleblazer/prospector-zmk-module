 ...
 * "USB" while the dongle is sending over USB. Always visible; the original
 * 280x240 layout hid it three seconds after a change and grew the battery
 * strip into its space, which the wide layout has no need for.
 */
